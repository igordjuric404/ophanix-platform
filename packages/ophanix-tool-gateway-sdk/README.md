...
| --- | --- | --- | --- |
| `0.1.x` | `/api/v1/gateway/tools` discovery and `/api/v1/tools/{name}/invoke` invocation | 3.11, 3.12, 3.13 | Beta. `product_platform.tool_gateway` imports are compatibility shims; prefer `ophanix_tool_gateway`. |
