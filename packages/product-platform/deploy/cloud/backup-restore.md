...
- Managed PostgreSQL point-in-time recovery: enabled.
- Snapshot schedule: hourly for 24 hours, daily for 14 days.
- Object storage versioning: enabled for artifact buckets.
- Secret manager replication: provider managed regional replication.

## Restore Drill

1. Provision an isolated staging database.
2. Restore the latest production-like snapshot into staging.
