...
def _seed_upstream_target(
    ...
    *,
    ...
    target_id = DIRECT_HTTP_TARGET_ID if tool_id == DIRECT_HTTP_TOOL_ID else f"target_direct_http_{tool_id}"
    connection.execute(
        """
    ...
    connection.execute(
        ...
        (
            f"health_{target_id}",
            target_id,
            DIRECT_HTTP_UPSTREAM_HEALTH_URL,
            200,
            60,
            None,
            None,
