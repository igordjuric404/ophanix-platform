...
CREATE TABLE IF NOT EXISTS tool_runtime_actions_new (
    id TEXT PRIMARY KEY,
...
INSERT INTO tool_runtime_actions_new (
...
ALTER TABLE tool_runtime_actions_new RENAME TO tool_runtime_actions;
